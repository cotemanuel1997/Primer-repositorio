...
# creo una segunda pila"

pila2 = Pila()

# vacio la primera pila y apilo los elemntos en la segunda, quedando invertido el contenido
# de la primera

while(not pila.pila_vacia()):
    x = pila.desapilar()
    pila2.apilar(x)
    print(pila2.cima.info)

# luego asigno la pila2 a la pila1
pila = pila2